        ...
        <div className="h-[600px] font-serif  w-[1050px] relative left-32 top-8 flex justify-around space-x-72">
          <div className="social w-[400]">
            ...
            <ul className="flex w-56 justify-around my-1">
              <li><a href="src/assets/Tarun_Resume.pdf" download={"Tarun_CV"}><img src="src/assets/cv.png" className="w-8"/></a></li>
              <li><a href="mailto:tarunnagle04@gmail.com"><img src="src/assets/gmail.png" className="w-9"/></a></li>
              <li><a target="_blank" href="https:tinyurl.com/tarunnagle04"><img src="src/assets/linkedin.png" className="w-8"/></a></li>
              <li><a target="_blank" href="https://github.com/tarunnagle04" rel="noreferrer"><img src="src/assets/github.png" className="w-8"/></a></li>
            </ul>
          </div>
          <div className="form w-[400px] justify-between">
            ...
            <div className="space-y-4">
              ...
              />
              <br />
              <button onClick={alarm} className="border-2 p-2 px-4 rounded-lg hover:bg-lime-500 transition-all duration-500">
                Send Message
              </button>
            </div>
          </div>
